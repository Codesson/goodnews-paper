...
const INSPIRING_KEYWORDS = [
  ...
  '꿈', '희망', '미래', '비전', '목표', '계획', '실현', '성취',
  '도전', '모험', '탐험', '발견', '새로운', '혁신', '창의', '창조',
  '치유', '회복', '재활', '복귀', '부활', '재생', '새생명', '새출발',
  '감사', '고마움', '은혜', '덕', '선', '착함', '착한', '선한',
  '희망', '기대', '믿음', '신뢰', '확신', '자신감', '긍정', '낙관',
  '사랑', '애정', '정', '우정', '친구', '동료', '동반자', '파트너',
  '성공', '달성', '완성', '완료', '달성', '이룸', '성취', '달성',
  '기적', '신기', '놀라운', '경이로운', '대단한', '훌륭한', '훌륭한',
  '영웅', '영웅적', '용감한', '대담한', '과감한', '용기있는',
  '희생', '헌신', '봉사', '자원봉사', '기부', '나눔', '선행', '착한',
  '감동', '감동적', '감동스러운', '감동받은', '감동받는', '감동을',
  '희망', '희망적', '희망찬', '희망을', '희망이', '희망의',
  '기쁨', '기쁜', '기쁘게', '기쁘다', '기쁨을', '기쁨이',
  '행복', '행복한', '행복하게', '행복하다', '행복을', '행복이',
  '사랑', '사랑하는', '사랑하는', '사랑하다', '사랑을', '사랑이',
  '따뜻', '따뜻한', '따뜻하게', '따뜻하다', '따뜻을', '따뜻이',
  '훈훈', '훈훈한', '훈훈하게', '훈훈하다', '훈훈을', '훈훈이',
  '감동', '감동적', '감동스러운', '감동받은', '감동받는', '감동을',
  '희망', '희망적', '희망찬', '희망을', '희망이', '희망의',
  '기쁨', '기쁜', '기쁘게', '기쁘다', '기쁨을', '기쁨이',
  '행복', '행복한', '행복하게', '행복하다', '행복을', '행복이',
